...
import { Navbar } from "./";
import aboutCV from "../Utils/Images/home-img.png";
    ...
    <>
      ...
      <Stack p={{ xs: "15px", sm: "25px", md: "40px", lg: "60px " }}>
        ...
        <Box mt="25px">
          ...
          <Box className="icons">
            <Link to="https://www.instagram.com/singh_aak_10">
              <Instagram
            ...
            <Link to="https://www.facebook.com/Aakashsingh3jp/">
            ...
            <Link to="https://www.linkedin.com/in/aakash-kumar-614a99214">
              <LinkedInIcon
                sx={{ fontSize: "40px", paddingLeft: "15px" }}
                color="primary"
              />
            ...
            <Link to="https://github.com/AakashKumar8">
              <GitHub
